...
import { RED, INK, BODY, STONE, FAINT, LINE, PAPER, CREAM, display, mono, sans, inputStyle, btnSolid, btnGhost } from "./theme";
...
export function PortalSignIn() {
  return (
    <Shell title="Sign in" subtitle="Asset Management uses your Dot One account. Sign in once at the portal and you are recognized here too.">
      <a href="https://portal.dot1.media" style={{ ...btnSolid, background: INK, width: "100%", justifyContent: "center", textDecoration: "none", boxSizing: "border-box" }}>Go to the Dot One portal</a>
